...
public class CustomList_Two extends ArrayAdapter<String>{
 ...
 //   }
    ...
    public CustomList_Two(Context context, ArrayList<String> dataItem) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_single_two, null);
        ...
        if (yesORno.contains(Constants.SMS_YES_Indicator)){
            String phoneNumberStr = getFields[1].substring(Constants.NUMBER_TITLE.length());
        ...
        String firstLetter = temp.substring(Constants.NAMESTR.length(), Constants.NAMESTR.length() + 1);
        ...
        if (colorCode.contains("ANONYMOUS")){
           // final int sdk = android.os.Build.VERSION.SDK_INT;
            if (Global.sdk >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                viewHolder.button_Review.setBackground(context.getResources().getDrawable(R.drawable.anonymous_icon, context.getTheme()));
                // viewHolder.in_or_out_Img.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.question_mark));
            } else {
                viewHolder.button_Review.setBackground(context.getResources().getDrawable(R.drawable.anonymous_icon));
            }
        }
        else{
        ...
        viewHolder.button_Review.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (customListner != null) {
                        customListner.onButtonClickListener(position, temp);
                    }
                }
        });
